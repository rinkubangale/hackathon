...
export default function Consignment({ data }) {
	return (
		<div className={styles.container}>
			<p>
				{" "}
				** Results are sorted by the shortest distance from origin and arrival,
				based on available trips and active users on the site.
			</p>

			{data.map((e, i) => {
				return (
					<div key={i} className={styles.consignments}>
						...
						<div className={styles.routeInfo}>
							<div className={styles.locationDiv}>
								<div className={styles.location}>
									<div className={styles.logo}>
										<img
											src="https://library.kissclipart.com/20180920/cfe/kissclipart-location-logo-green-clipart-green-logo-0f38de555911ac18.png"
											alt=""
										/>
									</div>
							...
							<div className={styles.moreDetails}>
								<span>
									<strong>Departure date</strong> {e.date}
								</span>

								<Link to={`/moredetails/${e._id}`}>
