			...
			<div className={style.footer_main_1}>
				<div className={style.footer_main_part2}>
					<div className={style.footer_main_part2_1}>
						<span className={style.he}>Your Account</span>
					...
					<div className={style.footer_main_part2_1}>
						<span className={style.he}>Discover</span>
						<ul style={{ listStyle: "none", margin: "0px", padding: "0px" }}>
							<li className={style.footer_main_part2_1_el}>
								{" "}
								<a href="/" className={style.footer_main_part2_1_el_li}>
					...
					<div className={style.footer_main_part2_1}>
						<span className={style.he}>Travaller Post</span>
						<ul style={{ listStyle: "none", margin: "0px", padding: "0px" }}>
							<li className={style.footer_main_part2_1_el}>
								{" "}
								<a href="/" className={style.footer_main_part2_1_el_li}>
				...
				<div className={style.footer_main_part4}>
					<span className={style.text_white}>©2021 Travaller Post</span>
